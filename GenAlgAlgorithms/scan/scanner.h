...
#undef yyFlexLexer
#define yyFlexLexer MathBase_FlexLexer // the trick with prefix; no namespace here :(
#include <FlexLexer.h>
#endif
...
#undef YY_DECL
#define YY_DECL MathBase::Parser::symbol_type MathBase::Scanner::get_next_token()
...
public:
	...
	virtual ~Scanner() {}
	virtual MathBase::Parser::symbol_type get_next_token();
